...
FString FUnrealAgentServer::HandleUndo(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: undo()"));
...
FString FUnrealAgentServer::HandleRedo(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: redo()"));
...
FString FUnrealAgentServer::HandleBeginTransaction(const FString& Body)
{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: begin_transaction('%s')"), *Description);
...
FString FUnrealAgentServer::HandleEndTransaction(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: end_transaction()"));
