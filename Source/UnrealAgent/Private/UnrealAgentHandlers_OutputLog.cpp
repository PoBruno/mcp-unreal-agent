...
FString FUnrealAgentServer::HandleGetOutputLog(const FString& Body)
{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: get_output_log(maxLines=%d)"), MaxLines);
...
FString FUnrealAgentServer::HandleClearOutputLog(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: clear_output_log()"));
