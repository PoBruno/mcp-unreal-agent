...
FString FUnrealAgentServer::HandleReparentBlueprint(const FString& Body)
{
		...
		BP->ParentClass != NewParentClass)
	{
		...
		UE_LOG(LogTemp, Warning,
			TEXT("UnrealAgent: Reparenting '%s' from '%s' to '%s' — classes are not in a direct hierarchy"),
			*BlueprintName, *OldParentName, *NewParentClass->GetName());
	}

	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Reparenting '%s' from '%s' to '%s'"),
		*BlueprintName, *OldParentName, *NewParentClass->GetName());
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Reparent complete, save %s"),
...
FString FUnrealAgentServer::HandleCreateBlueprint(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Creating Blueprint '%s' in '%s' with parent '%s' (type=%s)"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Created Blueprint '%s' with %d graphs (saved: %s)"),
...
FString FUnrealAgentServer::HandleCreateGraph(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Creating %s graph '%s' in Blueprint '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Created %s graph '%s' in '%s' (saved: %s)"),
...
FString FUnrealAgentServer::HandleDeleteGraph(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Deleting %s graph '%s' from Blueprint '%s'"),
		*GraphType, *GraphName, *BlueprintName);
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Deleted graph '%s' (%d nodes), save %s"),
...
FString FUnrealAgentServer::HandleRenameGraph(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid()) return MakeErrorJson(TEXT("Invalid JSON body"));
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Renaming %s graph '%s' to '%s' in Blueprint '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Renamed graph '%s' to '%s', save %s"),
