...
FString FUnrealAgentServer::HandleCreateMaterialInstance(const FString& Body)
{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Creating Material Instance '%s' in '%s' with parent '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Created Material Instance '%s' with parent '%s' (saved: %s)"),
...
FString FUnrealAgentServer::HandleSetMaterialInstanceParameter(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: %s parameter '%s' (type=%s) on Material Instance '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: %s parameter '%s' = %s on '%s'"),
...
FString FUnrealAgentServer::HandleGetMaterialInstanceParameters(const TMap<FString, FString>& Params)
{
...
FString FUnrealAgentServer::HandleReparentMaterialInstance(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: %s Material Instance '%s': parent '%s' -> '%s'"),
	...
	if (!bDryRun)
	{
		...
		UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Reparented Material Instance '%s' (saved: %s)"),
