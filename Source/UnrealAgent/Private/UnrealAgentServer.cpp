...
FString FUnrealAgentServer::JsonToString(TSharedRef<FJsonObject> JsonObj)
{
	FString Output;
...
FAssetData* FUnrealAgentServer::FindAnyAsset(const FString& NameOrPath)
{
...
FAssetData* FUnrealAgentServer::FindBlueprintAsset(const FString& NameOrPath)
{
...
FAssetData* FUnrealAgentServer::FindMapAsset(const FString& NameOrPath)
{
...
UBlueprint* FUnrealAgentServer::LoadBlueprintByName(const FString& NameOrPath, FString& OutError)
{
	...
	if (MapAsset)
	{
		...
		if (World && World->PersistentLevel)
		{
			...
			if (LevelBP)
			{
				UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Loaded level blueprint from map '%s'"),
					*NameOrPath);
				return LevelBP;
			}
		}
...
TSharedPtr<FJsonObject> FUnrealAgentServer::ParseBodyJson(const FString& Body)
{
...
FString FUnrealAgentServer::MakeErrorJson(const FString& Message)
{
...
FString FUnrealAgentServer::UrlDecode(const FString& EncodedString)
{
	FString Result;
...
UEdGraphNode* FUnrealAgentServer::FindNodeByGuid(
...
bool FUnrealAgentServer::Start(int32 InPort, bool bEditorMode)
{
	Port = InPort;
	bIsEditor = bEditorMode;

	// Scan asset registry
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Scanning asset registry..."));
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Found %d Blueprint assets."), AllBlueprintAssets.Num());
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Found %d Map assets (potential level blueprints)."), AllMapAssets.Num());

	// Scan for Material assets
	ARM.Get().GetAssetsByClass(UMaterial::StaticClass()->GetClassPathName(), AllMaterialAssets, false);
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Found %d Material assets."), AllMaterialAssets.Num());
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Found %d Material Instance assets."), AllMaterialInstanceAssets.Num());
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Found %d Material Function assets."), AllMaterialFunctionAssets.Num());
	...
	if (!Router.IsValid())
	{
		UE_LOG(LogTemp, Error, TEXT("UnrealAgent: Failed to create HTTP router on port %d"), Port);
		return false;
	}
		...
		FHttpRequestHandler::CreateLambda(
			[this](const FHttpServerRequest& Request, const FHttpResultCallback& OnComplete)
			{
				...
				else
				{
					...
					RequestEngineExit(TEXT("UnrealAgent /api/shutdown"));
				}
				TUniquePtr<FHttpServerResponse> R = FHttpServerResponse::Create(
					JsonToString(J), TEXT("application/json"));
				OnComplete(MoveTemp(R));
	...
	// --- R-01: scene / actor / level / editor routes (handlers existed but were never wired) ---
	// Level + actors (GET)
	Router->BindRoute(FHttpPath(TEXT("/api/current-level")), EHttpServerRequestVerbs::VERB_GET, QueuedHandler(TEXT("currentLevel")));
	Router->BindRoute(FHttpPath(TEXT("/api/list-actors")), EHttpServerRequestVerbs::VERB_GET, QueuedHandler(TEXT("listActors")));
	Router->BindRoute(FHttpPath(TEXT("/api/selected-actors")), EHttpServerRequestVerbs::VERB_GET, QueuedHandler(TEXT("getSelectedActors")));
	Router->BindRoute(FHttpPath(TEXT("/api/actor-properties")), EHttpServerRequestVerbs::VERB_GET, QueuedHandler(TEXT("actorProperties")));
	// Actor mutation (POST)
	Router->BindRoute(FHttpPath(TEXT("/api/spawn-actor")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("spawnActor")));
	Router->BindRoute(FHttpPath(TEXT("/api/delete-actor")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("deleteActor")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-actor-transform")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setActorTransform")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-actor-property")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setActorProperty")));
	Router->BindRoute(FHttpPath(TEXT("/api/attach-actor")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("attachActor")));
	Router->BindRoute(FHttpPath(TEXT("/api/detach-actor")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("detachActor")));
	Router->BindRoute(FHttpPath(TEXT("/api/duplicate-actor")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("duplicateActor")));
	Router->BindRoute(FHttpPath(TEXT("/api/rename-actor")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("renameActor")));
	Router->BindRoute(FHttpPath(TEXT("/api/find-actors-by-tag")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("findActorsByTag")));
	Router->BindRoute(FHttpPath(TEXT("/api/find-actors-by-class")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("findActorsByClass")));
	Router->BindRoute(FHttpPath(TEXT("/api/find-actors-in-radius")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("findActorsInRadius")));
	Router->BindRoute(FHttpPath(TEXT("/api/get-actor-bounds")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("getActorBounds")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-actor-tags")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setActorTags")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-actor-mobility")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setActorMobility")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-actor-visibility")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setActorVisibility")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-actor-physics")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setActorPhysics")));
	Router->BindRoute(FHttpPath(TEXT("/api/raycast")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("raycast")));
	// Selection (POST)
	Router->BindRoute(FHttpPath(TEXT("/api/get-editor-selection")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("getEditorSelection")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-editor-selection")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setEditorSelection")));
	Router->BindRoute(FHttpPath(TEXT("/api/clear-selection")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("clearSelection")));
	// Camera + view mode (POST)
	Router->BindRoute(FHttpPath(TEXT("/api/get-viewport-camera")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("getViewportCamera")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-viewport-camera")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setViewportCamera")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-view-mode")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setViewMode")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-show-flags")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setShowFlags")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-viewport-type")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setViewportType")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-realtime-rendering")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setRealtimeRendering")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-game-view")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setGameView")));
	// Editor utils (POST)
	Router->BindRoute(FHttpPath(TEXT("/api/focus-actor")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("focusActor")));
	Router->BindRoute(FHttpPath(TEXT("/api/editor-notification")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("editorNotification")));
	Router->BindRoute(FHttpPath(TEXT("/api/save-all")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("saveAll")));
	Router->BindRoute(FHttpPath(TEXT("/api/get-dirty-packages")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("getDirtyPackages")));
	// Content browser (POST)
	Router->BindRoute(FHttpPath(TEXT("/api/navigate-content-browser")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("navigateContentBrowser")));
	Router->BindRoute(FHttpPath(TEXT("/api/open-asset-editor")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("openAssetEditor")));
	// Output log (POST)
	Router->BindRoute(FHttpPath(TEXT("/api/get-output-log")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("getOutputLog")));
	Router->BindRoute(FHttpPath(TEXT("/api/clear-output-log")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("clearOutputLog")));
	// Undo / redo / transactions (POST)
	Router->BindRoute(FHttpPath(TEXT("/api/undo")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("undo")));
	Router->BindRoute(FHttpPath(TEXT("/api/redo")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("redo")));
	Router->BindRoute(FHttpPath(TEXT("/api/begin-transaction")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("beginTransaction")));
	Router->BindRoute(FHttpPath(TEXT("/api/end-transaction")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("endTransaction")));
	// Sublevels (POST)
	Router->BindRoute(FHttpPath(TEXT("/api/get-level-info")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("getLevelInfo")));
	Router->BindRoute(FHttpPath(TEXT("/api/list-sublevels")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("listSublevels")));
	Router->BindRoute(FHttpPath(TEXT("/api/load-sublevel")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("loadSublevel")));
	Router->BindRoute(FHttpPath(TEXT("/api/unload-sublevel")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("unloadSublevel")));
	// CVars (POST)
	Router->BindRoute(FHttpPath(TEXT("/api/get-cvar")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("getCVar")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-cvar")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setCVar")));
	Router->BindRoute(FHttpPath(TEXT("/api/list-cvars")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("listCVars")));
	// Widgets (POST)
	Router->BindRoute(FHttpPath(TEXT("/api/list-widget-tree")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("listWidgetTree")));
	Router->BindRoute(FHttpPath(TEXT("/api/get-widget-properties")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("getWidgetProperties")));
	Router->BindRoute(FHttpPath(TEXT("/api/add-widget")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("addWidget")));
	Router->BindRoute(FHttpPath(TEXT("/api/remove-widget")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("removeWidget")));
	Router->BindRoute(FHttpPath(TEXT("/api/set-widget-property")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("setWidgetProperty")));
	Router->BindRoute(FHttpPath(TEXT("/api/move-widget")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("moveWidget")));
	Router->BindRoute(FHttpPath(TEXT("/api/create-widget-blueprint")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("createWidgetBlueprint")));
	// PIE runtime (POST)
	Router->BindRoute(FHttpPath(TEXT("/api/pie-get-player-transform")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("pieGetPlayerTransform")));
	Router->BindRoute(FHttpPath(TEXT("/api/pie-teleport-player")), EHttpServerRequestVerbs::VERB_POST, QueuedHandler(TEXT("pieTeleportPlayer")));
	...
	{
		FSocket* TestSocket = ISocketSubsystem::Get(PLATFORM_SOCKETSUBSYSTEM)->CreateSocket(NAME_Stream, TEXT("UnrealAgent bind test"), false);
		if (TestSocket)
		{
		...
		UE_LOG(LogTemp, Warning, TEXT("UnrealAgent: Bind check attempt %d/5 failed on port %d, retrying..."), Attempt + 1, Port);
		FPlatformProcess::Sleep(1.0f);
	}

	if (!bListenerReady)
	{
		UE_LOG(LogTemp, Error, TEXT("UnrealAgent: Failed to bind HTTP listener on port %d. Port may be in use."), Port);
		HttpModule.StopAllListeners();
		return false;
	}

	bRunning = true;
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Server listening on http://localhost:%d"), Port);
	return true;
}

void FUnrealAgentServer::Stop()
{
	if (!bRunning) return;
	...
	HttpModule.StopAllListeners();
	bRunning = false;
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Server stopped."));
}

bool FUnrealAgentServer::ProcessOneRequest()
{
	...
	if (FRequestHandler* Handler = HandlerMap.Find(Req->Endpoint))
	{
		...
		{
			GEditor->BeginTransaction(FText::FromString(FString::Printf(TEXT("UnrealAgent: %s"), *Req->Endpoint)));
		}
...
void FUnrealAgentServer::RegisterHandlers()
{
	...
	// --- R-01: scene / actor / level / editor dispatch (handlers existed but were never registered) ---
	// Actor/level handlers take (Params, Body)
	...
	HandlerMap.Add(TEXT("getSelectedActors"),  [this](const TMap<FString, FString>& P, const FString& B) { return HandleGetSelectedActors(P, B); });
...
FString FUnrealAgentServer::HandleRescan()
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Rescanning asset registry..."));
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Rescan complete — BP %d→%d, Map %d→%d, Mat %d→%d, MI %d→%d, MF %d→%d"),
...
bool FUnrealAgentServer::SaveBlueprintPackage(UBlueprint* BP)
{
	UPackage* Package = BP->GetPackage();
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: SaveBlueprintPackage — begin for '%s'"), *BP->GetName());
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent:   Save target: %s"), *PackageFilename);
	...
	bool bCompiled = false;
	{
		...
		UE_LOG(LogTemp, Display, TEXT("UnrealAgent:   Phase 1: Attempting explicit compilation..."));
		...
		if (CompileResult == 0)
		{
			...
			UE_LOG(LogTemp, Display, TEXT("UnrealAgent:   Compilation %s (status=%d)"),
				bCompiled ? TEXT("succeeded") : TEXT("completed with warnings"), (int32)BP->Status);
		}
		else
		{
			UE_LOG(LogTemp, Warning, TEXT("UnrealAgent:   Compilation crashed (SEH), proceeding uncompiled"));
		}
#else
	...
	{
		UE_LOG(LogTemp, Display, TEXT("UnrealAgent:   Clearing read-only attribute on %s"), *PackageFilename);
	...
	if (bIsMapPackage)
	{
		...
		{
			BaseObject = World;
			UE_LOG(LogTemp, Display, TEXT("UnrealAgent:   Map package detected — saving UWorld '%s'"), *World->GetName());
		}
		else
		{
			UE_LOG(LogTemp, Warning, TEXT("UnrealAgent:   Map package detected but no UWorld found — saving with BP as base"));
		}
	}

	ESavePackageResult SaveResult = ESavePackageResult::Error;

	UE_LOG(LogTemp, Display, TEXT("UnrealAgent:   Phase 3: Calling UPackage::Save (compiled=%s, isMap=%s)..."),
	...
	if (SEHCode != 0)
	{
		UE_LOG(LogTemp, Error, TEXT("UnrealAgent:   UPackage::Save CRASHED (SEH exception caught)"));
	}
#else
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: SaveBlueprintPackage — %s for '%s' (compiled=%s, result=%d)"),
...
TSharedRef<FJsonObject> FUnrealAgentServer::SerializeBlueprint(UBlueprint* BP)
{
	TSharedRef<FJsonObject> J = MakeShared<FJsonObject>();
...
TSharedPtr<FJsonObject> FUnrealAgentServer::SerializeGraph(UEdGraph* Graph)
{
...
TSharedPtr<FJsonObject> FUnrealAgentServer::SerializeNode(UEdGraphNode* Node)
{
...
TSharedPtr<FJsonObject> FUnrealAgentServer::SerializePin(UEdGraphPin* Pin)
{
...
UClass* FUnrealAgentServer::FindClassByName(const FString& ClassName)
{
...
bool FUnrealAgentServer::ResolveTypeFromString(
...
FAssetData* FUnrealAgentServer::FindMaterialAsset(const FString& NameOrPath)
{
...
void FUnrealAgentServer::EnsureMaterialGraph(UMaterial* Material)
{
	if (!Material) return;
	if (!Material->MaterialGraph)
	{
...
UMaterial* FUnrealAgentServer::LoadMaterialByName(const FString& NameOrPath, FString& OutError)
{
...
FAssetData* FUnrealAgentServer::FindMaterialInstanceAsset(const FString& NameOrPath)
{
...
UMaterialInstanceConstant* FUnrealAgentServer::LoadMaterialInstanceByName(const FString& NameOrPath, FString& OutError)
{
...
FAssetData* FUnrealAgentServer::FindMaterialFunctionAsset(const FString& NameOrPath)
{
...
UMaterialFunction* FUnrealAgentServer::LoadMaterialFunctionByName(const FString& NameOrPath, FString& OutError)
{
...
bool FUnrealAgentServer::SaveMaterialPackage(UMaterial* Material)
{
	if (!Material) return false;
	return SaveGenericPackage(Material);
}

bool FUnrealAgentServer::SaveGenericPackage(UObject* Asset)
{
	if (!Asset) return false;
	UPackage* Package = Asset->GetPackage();
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: SaveGenericPackage — begin for '%s'"), *Asset->GetName());
	...
	if (SEHCode != 0)
	{
		UE_LOG(LogTemp, Error, TEXT("UnrealAgent: SaveGenericPackage CRASHED (SEH exception)"));
	}
#else
	...
	bool bSuccess = (SaveResult == ESavePackageResult::Success);
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: SaveGenericPackage — %s for '%s'"),
		bSuccess ? TEXT("SUCCEEDED") : TEXT("FAILED"), *Asset->GetName());
	return bSuccess;
}

TSharedPtr<FJsonObject> FUnrealAgentServer::SerializeMaterialExpression(UMaterialExpression* Expression)
{
...
FString FUnrealAgentServer::HandleExecCommand(const FString& Body)
{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: exec_command(\"%s\")"), *Command);
