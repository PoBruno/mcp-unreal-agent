...
FString FUnrealAgentServer::HandleGetEditorSelection(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: get_editor_selection()"));
...
FString FUnrealAgentServer::HandleSetEditorSelection(const FString& Body)
{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: set_editor_selection(%d actors)"), ActorLabelsArray->Num());
...
FString FUnrealAgentServer::HandleClearSelection(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: clear_selection()"));
