...
FString FUnrealAgentServer::HandleGetLevelInfo(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: get_level_info()"));
...
FString FUnrealAgentServer::HandleListSublevels(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: list_sublevels()"));
...
FString FUnrealAgentServer::HandleLoadSublevel(const FString& Body)
{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: load_sublevel('%s', visible=%s)"),
...
FString FUnrealAgentServer::HandleUnloadSublevel(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: unload_sublevel('%s')"), *LevelName);
