...
FString FUnrealAgentServer::HandleGetViewportCamera(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: get_viewport_camera()"));
...
FString FUnrealAgentServer::HandleSetViewportCamera(const FString& Body)
{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: set_viewport_camera()"));
