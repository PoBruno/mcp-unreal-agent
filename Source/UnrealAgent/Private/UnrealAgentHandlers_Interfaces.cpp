...
FString FUnrealAgentServer::HandleListInterfaces(const FString& Body)
{
...
FString FUnrealAgentServer::HandleAddInterface(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Adding interface '%s' to Blueprint '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Added interface '%s' to '%s' (%d function stubs, saved: %s)"),
...
FString FUnrealAgentServer::HandleRemoveInterface(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Removing interface '%s' from Blueprint '%s' (preserveFunctions: %s)"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Removed interface '%s' from '%s' (saved: %s)"),
