...
AActor* FUnrealAgentServer::FindActorByLabel(UWorld* World, const FString& Label)
{
...
bool FUnrealAgentServer::SaveLevelPackage(ULevel* Level)
{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: SaveLevelPackage — saving '%s'"), *PackageFilename);
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: SaveLevelPackage — %s for '%s'"),
...
FString FUnrealAgentServer::HandleGetCurrentLevel(const TMap<FString, FString>& Params, const FString&)
{
	if (!GEditor)
	{
...
FString FUnrealAgentServer::HandleGetSelectedActors(const TMap<FString, FString>& Params, const FString&)
{
	if (!GEditor)
	{
		return MakeErrorJson(TEXT("GEditor not available — not running in editor mode"));
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: GetSelectedActors — %d actors selected"), SelectedActors.Num());
...
FString FUnrealAgentServer::HandleListActors(const TMap<FString, FString>& Params, const FString&)
{
	if (!GEditor)
	{
		return MakeErrorJson(TEXT("GEditor not available — not running in editor mode"));
...
FString FUnrealAgentServer::HandleGetActorProperties(const TMap<FString, FString>& Params, const FString&)
{
	if (!GEditor)
	{
		return MakeErrorJson(TEXT("GEditor not available — not running in editor mode"));
...
FString FUnrealAgentServer::HandleSetActorTransform(const TMap<FString, FString>&, const FString& Body)
{
	if (!GEditor)
	{
		return MakeErrorJson(TEXT("GEditor not available — not running in editor mode"));
...
FString FUnrealAgentServer::HandleSetActorProperty(const TMap<FString, FString>&, const FString& Body)
{
	if (!GEditor)
	{
		return MakeErrorJson(TEXT("GEditor not available — not running in editor mode"));
...
FString FUnrealAgentServer::HandleSpawnActor(const TMap<FString, FString>&, const FString& Body)
{
	if (!GEditor)
	{
		return MakeErrorJson(TEXT("GEditor not available — not running in editor mode"));
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Spawned actor '%s' (%s) at (%.1f, %.1f, %.1f)"),
...
FString FUnrealAgentServer::HandleDeleteActor(const TMap<FString, FString>&, const FString& Body)
{
	if (!GEditor)
	{
		return MakeErrorJson(TEXT("GEditor not available — not running in editor mode"));
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Deleting actor '%s' (%s)"), *Label, *ActorClass);
