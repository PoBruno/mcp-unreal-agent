...
FString FUnrealAgentServer::HandleStartPIE(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: start_pie()"));
...
FString FUnrealAgentServer::HandleStopPIE(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: stop_pie()"));
...
FString FUnrealAgentServer::HandleIsPIERunning(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: is_pie_running()"));
...
FString FUnrealAgentServer::HandlePIEPause(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: pie_pause(%s)"), bPause ? TEXT("true") : TEXT("false"));
