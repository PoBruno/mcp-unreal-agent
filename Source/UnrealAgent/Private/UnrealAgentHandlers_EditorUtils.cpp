...
FString FUnrealAgentServer::HandleFocusActor(const FString& Body)
{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: focus_actor('%s')"), *ActorLabel);
...
FString FUnrealAgentServer::HandleEditorNotification(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: editor_notification('%s')"), *Message);
...
FString FUnrealAgentServer::HandleSaveAll(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: save_all()"));
...
FString FUnrealAgentServer::HandleGetDirtyPackages(const FString& Body)
{
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: get_dirty_packages()"));
