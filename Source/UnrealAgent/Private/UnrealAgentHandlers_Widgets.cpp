...
UWidgetBlueprint* FUnrealAgentServer::LoadWidgetBlueprintByName(const FString& NameOrPath, FString& OutError)
{
...
FString FUnrealAgentServer::HandleListWidgetTree(const FString& Body)
{
...
FString FUnrealAgentServer::HandleGetWidgetProperties(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
...
FString FUnrealAgentServer::HandleAddWidget(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Adding widget '%s' (%s) to Widget Blueprint '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Added widget '%s' (%s) to '%s' (parent: %s, saved: %s)"),
		*WidgetName, *WidgetClass->GetName(), *BlueprintName,
...
FString FUnrealAgentServer::HandleRemoveWidget(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Removing widget '%s' from Widget Blueprint '%s'"),
		*WidgetName, *BlueprintName);
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Removed widget '%s' from '%s' (saved: %s)"),
...
FString FUnrealAgentServer::HandleSetWidgetProperty(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Setting property '%s' on widget '%s' to '%s' (source: %s)"),
...
FString FUnrealAgentServer::HandleMoveWidget(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Moving widget '%s' to new parent '%s' in '%s'"),
...
FString FUnrealAgentServer::HandleCreateWidgetBlueprint(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Creating Widget Blueprint '%s' at '%s'"),
		*Name, *PackagePath);
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Created Widget Blueprint '%s' (saved: %s)"),
