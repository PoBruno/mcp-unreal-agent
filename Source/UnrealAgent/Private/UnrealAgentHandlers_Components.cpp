...
FString FUnrealAgentServer::HandleListComponents(const FString& Body)
{
...
FString FUnrealAgentServer::HandleAddComponent(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Adding component '%s' (%s) to Blueprint '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Added component '%s' (%s) to '%s' (parent: %s, saved: %s)"),
		*ComponentName, *ComponentClass->GetName(), *BlueprintName,
...
FString FUnrealAgentServer::HandleRemoveComponent(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Removing component '%s' from Blueprint '%s'"),
		*ComponentName, *BlueprintName);
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Removed component '%s' from '%s' (saved: %s)"),
