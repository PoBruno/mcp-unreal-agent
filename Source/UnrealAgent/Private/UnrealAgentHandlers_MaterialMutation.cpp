...
// SEH wrapper defined in UnrealAgentServer.cpp — catches crashes from abstract/invalid expression classes.
...
FString FUnrealAgentServer::HandleCreateMaterial(const FString& Body)
{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Creating Material '%s' in '%s'"), *Name, *PackagePath);
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Created Material '%s' (saved: %s)"),
...
FString FUnrealAgentServer::HandleSetMaterialProperty(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: %sSet material property '%s' on '%s': '%s' -> '%s'"),
...
FString FUnrealAgentServer::HandleAddMaterialExpression(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	if (bDryRun)
	{
		UE_LOG(LogTemp, Display, TEXT("UnrealAgent: [DRY RUN] Would add expression '%s' to '%s' at (%d, %d)"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Added expression '%s' to '%s' (nodeId: %s, saved: %s)"),
...
FString FUnrealAgentServer::HandleDeleteMaterialExpression(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	if (bDryRun)
	{
		UE_LOG(LogTemp, Display, TEXT("UnrealAgent: [DRY RUN] Would delete expression '%s' (nodeId: %s) from '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Deleted expression '%s' (nodeId: %s) from '%s' (saved: %s)"),
...
FString FUnrealAgentServer::HandleConnectMaterialPins(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	if (bDryRun)
	{
		UE_LOG(LogTemp, Display, TEXT("UnrealAgent: [DRY RUN] Would connect %s.%s -> %s.%s in '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Connecting %s.%s -> %s.%s in '%s'"),
		*SourceNodeId, *SourcePinName, *TargetNodeId, *TargetPinName, *AssetDisplayName);
...
FString FUnrealAgentServer::HandleDisconnectMaterialPin(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	if (bDryRun)
	{
		UE_LOG(LogTemp, Display, TEXT("UnrealAgent: [DRY RUN] Would disconnect pin '%s' on node '%s' in '%s' (%d links)"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Disconnecting pin '%s' on node '%s' in '%s' (%d links)"),
		*PinName, *NodeId, *AssetDisplayName, BrokenCount);
...
FString FUnrealAgentServer::HandleSetExpressionValue(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Set expression value on node '%s' (%s) in '%s': %s"),
...
FString FUnrealAgentServer::HandleMoveMaterialExpression(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	if (bDryRun)
	{
		UE_LOG(LogTemp, Display, TEXT("UnrealAgent: [DRY RUN] Would move node '%s' to (%d, %d) in '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Moved node '%s' to (%d, %d) in '%s' (saved: %s)"),
...
FString FUnrealAgentServer::HandleCreateMaterialFunction(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Creating Material Function '%s' in '%s'"), *Name, *PackagePath);
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Created Material Function '%s' (saved: %s)"),
		*Name, bSaved ? TEXT("true") : TEXT("false"));
...
FString FUnrealAgentServer::HandleSnapshotMaterialGraph(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Creating snapshot for material '%s'"), *MaterialName);
	...
	while (MaterialSnapshots.Num() > MaxSnapshots)
	{
		...
		if (!OldestId.IsEmpty())
		{
			UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Pruning old material snapshot '%s'"), *OldestId);
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Material snapshot '%s' created with %d nodes, %d connections"),
...
FString FUnrealAgentServer::HandleDiffMaterialGraph(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Diffing material '%s' against snapshot '%s'"), *MaterialName, *SnapshotId);
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Material diff complete — %d severed, %d new, %d missing nodes"),
...
FString FUnrealAgentServer::HandleRestoreMaterialGraph(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Restoring material connections from snapshot '%s' for material '%s' (dryRun=%s)"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Material restore complete — %d reconnected, %d failed, saved=%s"),
