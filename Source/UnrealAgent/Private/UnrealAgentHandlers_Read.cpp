...
FString FUnrealAgentServer::HandleList(const TMap<FString, FString>& Params)
{
...
FString FUnrealAgentServer::HandleGetBlueprint(const TMap<FString, FString>& Params)
{
...
FString FUnrealAgentServer::HandleGetGraph(const TMap<FString, FString>& Params)
{
	const FString* Name = Params.Find(TEXT("name"));
...
FString FUnrealAgentServer::HandleSearch(const TMap<FString, FString>& Params)
{
...
FString FUnrealAgentServer::HandleTestSave(const TMap<FString, FString>& Params)
{
	const FString* Name = Params.Find(TEXT("name"));
	if (!Name || Name->IsEmpty())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: test-save requested for '%s'"), **Name);
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: test-save — loaded '%s', GeneratedClass=%s"),
		*BP->GetName(),
...
FString FUnrealAgentServer::HandleFindReferences(const TMap<FString, FString>& Params)
{
...
FString FUnrealAgentServer::HandleSearchByType(const TMap<FString, FString>& Params)
{
...
FString FUnrealAgentServer::HandleGetSkeleton(const TMap<FString, FString>& Params)
{
...
FString FUnrealAgentServer::HandleAddSkeletonSocket(const FString& Body)
{
...
FString FUnrealAgentServer::HandleRemoveSkeletonSocket(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
...
FString FUnrealAgentServer::HandleCopySkeletonSockets(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
