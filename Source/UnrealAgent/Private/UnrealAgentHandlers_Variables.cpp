...
FString FUnrealAgentServer::HandleChangeVariableType(const FString& Body)
{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: %s variable '%s' in '%s' to %s (%s)"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Variable type changed, save %s"),
...
FString FUnrealAgentServer::HandleAddVariable(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Adding variable '%s' (type=%s, array=%s) to Blueprint '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Added variable '%s' to '%s' (saved: %s)"),
...
FString FUnrealAgentServer::HandleRemoveVariable(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Removing variable '%s' from Blueprint '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Removed variable '%s' from '%s' (saved: %s)"),
		*VariableName, *BlueprintName, bSaved ? TEXT("true") : TEXT("false"));
...
FString FUnrealAgentServer::HandleSetVariableMetadata(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
