...
FString FUnrealAgentServer::HandleChangeFunctionParamType(const FString& Body)
{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Changing param '%s' in %s '%s' of '%s' to %s"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Parameter type changed, save %s"),
...
FString FUnrealAgentServer::HandleRemoveFunctionParameter(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Removing param '%s' from %s '%s' in '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Parameter removed, save %s"),
		bSaved ? TEXT("succeeded") : TEXT("failed"));
...
FString FUnrealAgentServer::HandleAddFunctionParameter(const FString& Body)
{
	TSharedPtr<FJsonObject> Json = ParseBodyJson(Body);
	if (!Json.IsValid())
	{
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Adding parameter '%s' (type=%s) to %s '%s' in Blueprint '%s'"),
	...
	UE_LOG(LogTemp, Display, TEXT("UnrealAgent: Added parameter '%s' to '%s' in '%s' (saved: %s)"),
